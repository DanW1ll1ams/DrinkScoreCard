package uk.me.danwilliams.drinkscorecard;
...
public class ListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            holder.strokeLabel = (TextView) convertView.findViewById(R.id.strokeCount);
        ...
        holder.addStrokeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                holder.strokeLabel.setText(updatedStrokeCount + "");
            }
        });
